...
export default function RegisterPage() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Inter, sans-serif', backgroundColor: '#fdfbf7' }}>
      ...
      <div style={{ flex: 1, backgroundColor: '#5a0f28', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ zIndex: 2, textAlign: 'center', color: '#fff' }}>
          <div style={{ fontSize: '5rem', marginBottom: '1rem' }}>✂️</div>
          <h1 style={{ fontFamily: '"Playfair Display", serif', margin: 0, fontSize: '3.5rem', fontStyle: 'italic' }}>StitchEase</h1>
          <p style={{ letterSpacing: '3px', fontSize: '1rem', textTransform: 'uppercase', marginTop: '1rem', opacity: 0.8 }}>Crafting Elegance, Tailored to You</p>
        </div>
      </div>
